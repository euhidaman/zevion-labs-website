...
function HomePage() {
  ...
  return (
    <div className="item-center flex flex-col flex-nowrap p-5">
      <div
        ref={heroRef}
        className="hero space-y-4 pt-[116px] pb-8 md:pt-[128px] md:pb-6 md:text-center lg:pt-[140px] lg:pb-2"
      >
        <SectionHeading
        ...
        {/* <div className="relative" role="region" aria-label="Our trusted clients">
          ...
          <div className="pointer-events-none absolute top-0 left-0 z-10 h-full w-12 bg-gradient-to-r from-background via-background/90 to-transparent md:w-48"></div>
          
          <div className="pointer-events-none absolute top-0 right-0 z-10 h-full w-12 bg-gradient-to-l from-background via-background/90 to-transparent md:w-48"></div>
        ...
        >
          ...
          <div className="pointer-events-none absolute top-0 left-0 z-5 h-full w-12 bg-gradient-to-r from-background/80 via-background/20 to-transparent md:w-36"></div>

          <div className="pointer-events-none absolute top-0 right-0 z-5 h-full w-12 bg-gradient-to-l from-background/90 via-background/20 to-transparent md:w-36"></div>
