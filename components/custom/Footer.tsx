...
function Footer() {
  ...
  const socialLinks = [
    ...
    { name: "LinkedIn", href: "https://www.linkedin.com/in/euhidaman/" },
    { name: "Github", href: "https://github.com/euhidaman" },
  ];

  return (
    <div className="mt-10 bg-[linear-gradient(to_bottom,var(--background)_0%,var(--background)_20%,_rgb(29_39_54/0.8)_22%,_black_100%)]">
      <div
            ...
            <div className="space-y-8 md:col-span-5 lg:col-span-4">
              <div className="space-y-6">
                ...
                >
                  <Image
                    src="/zevion-logo.png"
                    alt="Zevion Labs Logo"
                    width={400}
                    height={133}
                    className="h-32 w-auto mb-6 invert brightness-200"
                  />
                  <p className="text-sm">Copyrights © All Rights Reserved by Zevion Labs</p>
                  {/* <p className="text-sm">
                  ...
                  >
                    <span itemProp="streetAddress">
                      ...
                      No. 43, Section 4, Keelung
                      Rd, Da’an District
                    </span>
                  </p>
                  <p className="text-sm">
                    <span itemProp="addressLocality">Taipei City</span>,
                    <span itemProp="postalCode">106335</span>
                  </p>
                </div>
